...
def log_spatial_predictions(
    ...
    for timestep_key, queries in results.items():
        ...
        assert isinstance(
            queries, dict
        ), "log_spatial_predictions expects grouped results (dict with 'objects' and 'actions')."
